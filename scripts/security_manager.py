...
def validate_api_key(exchange: str, api_key: Optional[str], secret: Optional[str], security_manager: SecurityManager):
...
def store_credentials(exchange: str, api_key: Optional[str], secret: Optional[str], secrets_config_manager: SecretsConfigManager):
