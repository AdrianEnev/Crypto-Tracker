...
class MarketImpactCalculator:
    ...
    def _calculate_permanent_impact(self, participation_rate: float, context: SlippageContext) -> float:
    ...
    def _calculate_temporary_impact(self, participation_rate: float, context: SlippageContext) -> float:
    ...
    def _assess_market_condition(self, context: SlippageContext, participation_rate: float) -> MarketCondition:
    ...
    def calculate_optimal_execution(self, total_quantity: float, context: SlippageContext) -> Dict[str, any]:
        """
    ...
    def _estimate_strategy_impact(self, strategy: str, num_slices: int, context: SlippageContext) -> float:
    ...
    def analyze_liquidity_consumption(self, context: SlippageContext, time_horizon_hours: float = 1.0) -> Dict[str, float]:
        """
