...
class OrderRetryManager:
    ...
    def execute_with_retry(
        ...
        order: Order,
        executor: Any,
        execution_func: Callable[[Order], OrderResult]
    ) -> OrderResult:
    ...
    def _calculate_delay(self, retry_count: int) -> float:
        ...
        # Exponential backoff
        delay = self.config.base_delay_seconds * (self.config.backoff_multiplier ** (retry_count - 1))
    ...
    def _record_execution_metrics(self, exchange: str, result: OrderResult, execution_time_ms: float) -> None:
