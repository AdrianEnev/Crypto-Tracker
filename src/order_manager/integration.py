...
class OrderManagerAdapter:
    ...
    def __init__(self, order_manager: OrderManager):
        ...
        self.execution_mode_map = {"paper": "paper", "live": "binance"}  # Default live exchange
    ...
    def execute_sell_order(
        self, symbol: str, coin_id: str, current_price: float, reason: str
    ) -> bool:
...
class OrderManagerIntegration:
    ...
    def _create_order_manager_config(self, config: Optional[Dict[str, Any]]) -> OrderManagerConfig:
        ...
        twap_config = TWAPConfig(
            ...
            min_slice_interval_seconds=order_config.get("twap", {}).get(
    ...
    def _register_existing_executors(self) -> None:
        ...
        if hasattr(self.tracker, "live_executor") and self.tracker.live_executor:
            live_executor = EnhancedCCXTExecutor(self.tracker.live_executor, self.order_manager)
