...
class ExchangeFeeRegistry:
    ...
    def _register_binance(self) -> None:
        ...
        binance = ExchangeFeeStructure(
            ...
            supported_assets=[
                "BTC", "ETH", "BNB", "ADA", "DOT", "LINK", "LTC", "BCH", 
                "XLM", "XRP", "EOS", "TRX", "XMR", "DASH", "NEO", "IOTA"
            ]
        )
    ...
    def _register_coinbase(self) -> None:
        ...
        coinbase = ExchangeFeeStructure(
            ...
            supported_assets=[
                "BTC", "ETH", "LTC", "BCH", "XRP", "ETC", "ZRX", "BAT",
                "REP", "ZEC", "DASH", "XLM", "ADA", "EOS", "XTZ"
            ]
        )
    ...
    def _register_bybit(self) -> None:
        ...
        bybit = ExchangeFeeStructure(
            ...
            supported_assets=[
                ...
                "MATIC", "UNI", "LTC", "BCH", "ATOM", "NEAR", "FTM"
            ]
        )
    ...
    def _register_kraken(self) -> None:
        ...
        kraken = ExchangeFeeStructure(
            ...
            supported_assets=[
                "BTC", "ETH", "LTC", "BCH", "XRP", "ETC", "ZEC", "DASH",
                "XMR", "REP", "XLM", "ADA", "DOT", "LINK", "UNI"
            ]
        )
