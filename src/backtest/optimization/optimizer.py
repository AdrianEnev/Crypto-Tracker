...
class OptimizationRunner:
    ...
    def optimize_coin(self, coin_id: str, max_combinations: int = None) -> List[EvalResult]:
        ...
        try:
            ...
            self.console.print(
                f"[blue]Testing {total_combinations} parameter combinations for {coin_id}...[/blue]"
            )
            ...
            for i, params in enumerate(track(combinations, description=f"Optimizing {coin_id}")):
                ...
                try:
                    ...
                    self.console.print(
                        f"[red]Error evaluating parameters for {coin_id}: {ex}[/red]"
                    )
                    continue
    ...
    def optimize_all_coins(
        self, max_combinations_per_coin: int = None
