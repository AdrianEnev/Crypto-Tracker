...
class ParameterGenerator:
    ...
    def _get_parameter_ranges(self, coin_id: str, optimize_config: Dict[str, Any]) -> Dict[str, List[Any]]:
    ...
    def filter_combinations(self, combinations: Iterator[Dict[str, Any]], filters: Dict[str, Any]) -> Iterator[Dict[str, Any]]:
