...
class TradingSimulator:
        ...
        try:
            ...
            for i in range(len(closes)):
                ...
                # Execute sell
                    ...
                    exit_value = current_position.units * current_price if hasattr(current_position, 'units') else 0
                ...
                position_value = 0.0
                if current_position is not None:
                    position_value = current_position.units * current_price if hasattr(current_position, 'units') else 0
            ...
            if current_position is not None:
                ...
                exit_value = current_position.units * final_price if hasattr(current_position, 'units') else 0
                fee = exit_value * (fee_bps / 10000.0)
                net_proceeds = exit_value - fee
    ...
    def _check_exit_conditions(self, position: Trade, current_price: float, atr_val: Optional[float], atr_params: Optional[ATRRiskParams]) -> bool:
