...
class OrderBookSimulator:
    ...
    def _simulate_market_order(
        self, order: SimulatedOrder, execution_start: datetime
    ) -> SimulatedFill:
    ...
    def _simulate_partial_fill(
        self, order: SimulatedOrder, depth, execution_start: datetime, side: str
    ) -> SimulatedFill:
    ...
    def _create_immediate_fill(
        self, order: SimulatedOrder, price: float, execution_start: datetime
    ) -> SimulatedFill:
    ...
    def get_simulation_statistics(self) -> Dict[str, Any]:
        ...
        avg_execution_time = (
            sum(fill.execution_time_ms for fill in self.simulation_results) / total_orders
        )
        avg_slippage = sum(fill.slippage_bps for fill in self.simulation_results) / total_orders
        avg_market_impact = (
            sum(fill.market_impact_bps for fill in self.simulation_results) / total_orders
        )
