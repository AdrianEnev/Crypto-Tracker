...
class OrderBookReplayEngine:
    ...
    def get_replay_statistics(self, symbol: str, start_time: datetime, end_time: datetime) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_snapshot_interval_seconds": sum(snapshot_intervals) / len(snapshot_intervals) if snapshot_intervals else 0,
            "avg_event_interval_seconds": sum(event_intervals) / len(event_intervals) if event_intervals else 0,
